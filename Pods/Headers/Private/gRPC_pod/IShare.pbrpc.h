...
- (void)obtain_settingWithRequest:(Inf *)request handler:(void(^)(Setting *response, NSError *error))handler;

- (ProtoRPC *)RPCToObtain_settingWithRequest:(Inf *)request handler:(void(^)(Setting *response, NSError *error))handler;


#pragma mark Reset_setting(Setting) returns (Inf)

- (void)reset_settingWithRequest:(Setting *)request handler:(void(^)(Inf *response, NSError *error))handler;

- (ProtoRPC *)RPCToReset_settingWithRequest:(Setting *)request handler:(void(^)(Inf *response, NSError *error))handler;


#pragma mark Reset_userInfo(UserInfo) returns (Inf)

- (void)reset_userInfoWithRequest:(UserInfo *)request handler:(void(^)(Inf *response, NSError *error))handler;

- (ProtoRPC *)RPCToReset_userInfoWithRequest:(UserInfo *)request handler:(void(^)(Inf *response, NSError *error))handler;


#pragma mark Obtain_userInfo(Inf) returns (UserInfo)

- (void)obtain_userInfoWithRequest:(Inf *)request handler:(void(^)(UserInfo *response, NSError *error))handler;

- (ProtoRPC *)RPCToObtain_userInfoWithRequest:(Inf *)request handler:(void(^)(UserInfo *response, NSError *error))handler;
