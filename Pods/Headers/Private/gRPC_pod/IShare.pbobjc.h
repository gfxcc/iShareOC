...
typedef GPB_ENUM(Search_result_FieldNumber) {
  Search_result_FieldNumber_UsernameArray = 1,
  Search_result_FieldNumber_UserIdArray = 2,
  Search_result_FieldNumber_UserIconArray = 3,
};

@interface Search_result : GPBMessage
...
@property(nonatomic, readwrite, strong, null_resettable) NSMutableArray<NSData*> *userIconArray;
...
typedef GPB_ENUM(User_detail_FieldNumber) {
  ...
  User_detail_FieldNumber_FriendsLastModifiedArray = 6,
};
...
@property(nonatomic, readwrite, strong, null_resettable) NSMutableArray<NSString*> *friendsNameArray;
/** The number of items in @c friendsNameArray without causing the array to be created. */
@property(nonatomic, readonly) NSUInteger friendsNameArray_Count;

@property(nonatomic, readwrite, strong, null_resettable) NSMutableArray<NSString*> *friendsIdArray;
/** The number of items in @c friendsIdArray without causing the array to be created. */
@property(nonatomic, readonly) NSUInteger friendsIdArray_Count;

@property(nonatomic, readwrite, strong, null_resettable) NSMutableArray<NSString*> *friendsLastModifiedArray;
/** The number of items in @c friendsLastModifiedArray without causing the array to be created. */
@property(nonatomic, readonly) NSUInteger friendsLastModifiedArray_Count;
